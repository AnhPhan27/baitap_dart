...
//  Cho 1 danh sách học sinh List students= [“Thắng”, “Minh”,”Anh”, “Vũ Bảo”]
  ...
  List<String> students = ['Thang', 'Minh', 'Anh', 'Vũ', 'Bảo'];
  ...
  students.removeAt(students.indexWhere((note) => note.startsWith('M')));
...
//  3.3 Nếu học sinh tên Anh thì in ra “ Đây là minh “
  ...
  for (var i in students) {
    if (students.contains('Sapa')) {
      print('Danh sach lop co Sapa');
    } else {
      print("danh sach lop khong co Sapa");
    }
  }
  ...
  List<String> newListStudents = students.map((e) => '$e + 9').toList();
